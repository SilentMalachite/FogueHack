...
FogueHackプロジェクトの包括的なドキュメントです。目的に応じて適切なドキュメントを参照してください。
...
**Q: 開発環境がうまく動かない**
A: [DEVELOPER_GUIDE.md](./DEVELOPER_GUIDE.md#🆘-よくある問題と解決法) のトラブルシューティングを確認

**Q: ゲームシステムの仕組みがわからない**
A: [GAME_SYSTEMS.md](./GAME_SYSTEMS.md) で詳細な説明を確認

**Q: APIの使い方がわからない**
A: [API.md](./API.md) でエンドポイント仕様を確認

**Q: 新機能の実装方法がわからない**
A: [DEVELOPER_GUIDE.md](./DEVELOPER_GUIDE.md#🎮-ゲームシステム開発) の実装例を参考

### サポート

- **GitHub Issues**: バグ報告、機能リクエスト
- **GitHub Discussions**: 一般的な質問、アイデア討論
- **Pull Request**: コードレビュー、実装相談

## 📝 ドキュメント改善

ドキュメントの改善提案は大歓迎です：

1. **誤字・脱字**: 直接 Pull Request をお送りください
2. **内容の改善**: GitHub Issues で提案してください
3. **新しいドキュメント**: GitHub Discussions で相談してください

### ドキュメント作成ガイドライン

- **読者を意識**: 対象者（初心者/上級者）を明確に
- **構造化**: 見出し、リスト、表を効果的に使用
- **具体例**: コード例、実行例を豊富に提供
- **最新性**: 実装と齟齬がないよう定期更新
- **日本語**: 基本的に日本語で記述（コードコメントも）

## 🔄 更新履歴

- **2024-01**: 包括的なドキュメント整備
  - API仕様書作成
  - ゲームシステム詳細説明追加
  - アーキテクチャ設計書作成
  - デプロイメントガイド作成
